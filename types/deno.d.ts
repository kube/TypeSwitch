...
declare namespace Deno {
  ...
  export interface ReadWriteCloser
    extends Reader,
      Writer,
      Closer {}
  export interface ReadWriteSeeker
    extends Reader,
      Writer,
      Seeker {}
  ...
  export class File
    implements Reader, Writer, Seeker, Closer {
    readonly rid: number;
...
declare namespace domTypes {
  ...
  interface AbortSignal extends EventTarget {
    ...
    onabort:
      | ((this: AbortSignal, ev: ProgressEvent) => any)
      | null;
...
declare namespace event {
  ...
  export class Event implements domTypes.Event {
    ...
    constructor(
      type: string,
      eventInitDict?: domTypes.EventInit
    );
    readonly bubbles: boolean;
...
declare namespace customEvent {
  ...
  export class CustomEvent extends event.Event
